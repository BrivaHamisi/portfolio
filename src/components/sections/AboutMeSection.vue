<template>
  <div class="bg-void w-full py-12">
    <div v-reveal class="text-paper p-5 sm:p-8 max-w-7xl mx-4 sm:mx-6 lg:mx-auto bg-carbon rounded-xl shadow-card">
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
        <div class="col-span-1 lg:col-span-2">
          <img
            src="/images/brand/profile.webp"
            alt="Briva Hamisi"
            width="400"
            height="500"
            loading="lazy"
            class="w-full h-auto max-h-[32rem] rounded-xl mb-6 object-contain lg:h-full lg:max-h-none lg:object-cover"
          />
        </div>
        <div class="col-span-1 lg:col-span-3 text-left">
          <h2 class="text-heading-sm sm:text-heading font-[510] text-paper mb-4">About Briva Hamisi</h2>
          <h3 class="text-body-sm sm:text-body-lg font-[510] text-mist mb-4">Software Engineer | Full Stack Developer | Creative Designer</h3>
          <p class="text-body-sm text-fog mb-4">
          ...
          <button
            ...
            class="mt-6 min-h-11 px-3 py-2 border border-graphite text-mist text-caption rounded-md hover:border-smoke transition duration-300"
          >
